...
{
    /// <inheritdoc />
<<<<<<<< HEAD:PharmaProjectAPI/Migrations/20250624182327_add.cs
    public partial class add : Migration
========
    public partial class lll : Migration
>>>>>>>> 6434f5352f017a1f845b32055e0fc057863c6b21:PharmaProjectAPI/Migrations/20250624081720_lll.cs
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ppu = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseCarts_Medicines_MedicineId",
                        column: x => x.MedicineId,
                        principalTable: "Medicines",
                        principalColumn: "MedicineId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PurchaseCarts_Suppliers_SupplierId",
...
>>>>>>>> 6434f5352f017a1f845b32055e0fc057863c6b21:PharmaProjectAPI/Migrations/20250624081720_lll.cs
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseCarts_MedicineId",
                table: "PurchaseCarts",
                column: "MedicineId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseCarts_SupplierId",
                table: "PurchaseCarts",
                column: "SupplierId");
